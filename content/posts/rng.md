...
_Proof_. $\mathbb P(X=k)=\mathbb P(\lfloor nU\rfloor=k)=\mathbb P(nU\in [k,k+1))=\mathbb P(U\in [k/n,(k+1)/n))=1/n$.
...
_Proof_. $\mathbb P(X=a_K)=\mathbb P(\sum_{i=1}^{k-1}p_i<U,\sum_{i=1}^k p_i\geq U)=p_k$.
