...
(_i.e._, the physic of this designed world).
...
the lack of fidelity, _i.e._, the generated charts cannot accurately encode
...
compared with the charts generated by machine code (_e.g._ D3.js).
...
That is, the generated chart elements (_i.e._, bars, points) cannot be
...
Given conditional controls (_e.g._, sketch, edges, segmentation), the models
...
simply refering to some basic statistics (_e.g._, proportion, or number).
